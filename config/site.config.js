...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'sekai@y8rt7.onmicrosoft.com',
  ...
  protectedRoutes: ['/🌞 SEKAI-ARCHIVIST/LIBRARY', '/🥟 Some test files/Protected route'],
